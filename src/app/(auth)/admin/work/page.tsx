                                                        ...
                                                        <div className="space-y-4">
                                                            <div className="space-y-2">
                                                                ...
                                                                <p className="text-sm text-muted-foreground">
                                                                    Type <span className="font-mono bg-muted px-1 rounded">sudo delete {work.company?.name}</span> to confirm.
                                                                </p>
                                                            </div>
                                        ...
                                        <div className="pt-2">
                                            <div className="flex flex-wrap gap-2">
                                                ...
                                                {work.technologies?.length > 5 && (
                                                    <span className="text-xs text-muted-foreground self-center">+{work.technologies.length - 5} more</span>
                                                )}
                                            </div>
                                        </div>
                                    </div>
