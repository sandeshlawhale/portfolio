...
const Footer = () => {
  return (
    <div className="w-full pb-28 lg:pb-8 pt-10 flex flex-col items-center justify-center text-center gap-1">
      <div className="flex flex-wrap items-center justify-center gap-2 text-sm text-mutedText tracking-wider">
        <span>© 2026 Sandesh Lawhale</span>
        <span className="opacity-50">·</span>
        <Link href="https://github.com/sandeshlawhale" target="_blank" className="hover:text-primaryText transition-colors">GitHub</Link>
        <span className="opacity-50">·</span>
